...
import * as identifers from './Schema/identifiers';
...
describe('SchemaApi', () => {
  ...
  it('should create identifier',
    async () => {
      jest.spyOn(identifers, 'createIdentifier').mockReturnValue(Promise.resolve({} as any));
      ...
      expect(identifers.createIdentifier).toHaveBeenCalledWith(odpClient.v3Api, identifier);
    });

  it('should enable module',
    async () => {
